...
Route::add('/categories/(.*)/delete', function($id) {
    global $categories;
    
    $result = $categories->deleteCategories($id);
    return $result;
...
Route::add('/roles/(.*)/(.*)/delete', function($identifier,$id) {
    global $roles;
    
    $result = $roles->deleteRoles($identifier,$id);
    return $result;
...
// Route::add('/subscription/update', function() {
//     global $subscription;
...
//         // decode the json data
//         $data = json_decode($json);
//         $result = $subscription->update_subscription($data);
//         return $result;
//     }
//     else {
//         error_log("Error in update subscription");
//         return false;
//     }
// },'patch');

// Route::add('/subscription/(.*)/(.*)/delete', function($identifier,$id) {
//     global $subscription;
    
//     $result = $subscription->deleteSubscription($identifier,$id);
//     return $result;
